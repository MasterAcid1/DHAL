...
class Client {
	...
	<button id='button' class='btn btn-danger'>Custom plan - Dhal 150 bots</button>
        ...
        `);
        if (!localStorage.getItem('botAmount')) localStorage.setItem('botAmount', 150);
